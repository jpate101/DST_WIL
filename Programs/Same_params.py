# -*- coding: utf-8 -*-
"""
Created on Thu Jan 14 09:28:05 2021
...
if __name__=="__main__":
    ...
    dir_in_2 = "old_data\T4v4_6\inputs"
    dir_out_2 = "old_data\T4v4_6\outputs"

    X,Y = Dataset_prepare(dir_in_2,dir_out_2,10125,20)
    X_2 = X
    Y_2 = Y
    ...
    print("preparing data from input and output files")
    dir_in_2 = "old_data\T4v4_6_2\inputs"
    dir_out_2 = "old_data\T4v4_6_2\outputs"
    ...
    print("preparing data from input and output files")
    dir_in_3 = "old_data\T4v4_6_3\inputs"
    dir_out_3 = "old_data\T4v4_6_3\outputs"

    X,Y = Dataset_prepare(dir_in_3,dir_out_3,10125,20)
    X_2 = X
    Y_2 = Y
