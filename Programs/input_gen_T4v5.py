# -*- coding: utf-8 -*-
"""
Created on Sat Jan  9 12:41:35 2021
...
"""
#v5
displaced_v = [5250,5750,6250]   
length =  [150,135,125]
draft =  [4.55,5.05,5.55]
trim = [0,3,6]
offset_s1_0 = [.2,.4,.6,.8,1]
offset_s1_1 = [.1,.3,.5,.7,.9]
offset_s1_2 = [.1,.3,.5,.7,.9]
"""
"""
#t4v4_5
displaced_v = [5000,5500,6000]   
length =  [142.5,130,117.5]
draft =  [4.55,5.05,5.55]
trim = [0,3,6]
offset_s1_0 = [.2,.4,.6,.8,1]
offset_s1_1 = [.1,.3,.5,.7,.9]
                ...
                for y0 in offset_s1_0:
                    for y1 in offset_s1_1:
                        for y2 in offset_s1_2:
                            ...
                            count = count + 1                        
                            filename = ("old_data\T4v4_6_3\inputs/input%d.mlt" % (count))
                            f = open(filename, "x")
                            f = open(filename, "w")
                            f.write("""
