...
displaced_v = [6000]#[5000,5500,6000,6500]   # [0.125,.075,.2,.275,.35]
length = [135] # [150,135,125,110]
draft = [5.3]  # [4.3,4.8,5.3,5.8]
            ...
            for y0 in offset_s1_0:
                for y1 in offset_s1_1:
                    for y2 in offset_s1_2:
                        ...
                        count = count + 1                        
                        filename = ("old_data\T3v3\inputs/input%d.mlt" % (count))
                        f = open(filename, "x")
                        f = open(filename, "w")
                        f.write("""
