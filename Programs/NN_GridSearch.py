# -*- coding: utf-8 -*-
"""
Created on Tue Dec 22 15:02:06 2020
...
def Dataset_prepare():
    ...
    X, X_test_bin, Y, Y_test_bin = train_test_split(X,Y, test_size = 0.9, random_state = 0)
...
if __name__=="__main__":
    ...
    for i in range(0, 3):
        clf = GridSearchCV(KNeighborsRegressor(n_neighbors=4,weights='distance',algorithm='ball_tree'),{
            #'n_neighbors' : [3,4,5,6],
    ...
    #print(df[['mean_test_score','param_n_neighbors','param_weights','param_algorithm']])
    print(df[['mean_test_score','param_leaf_size']])
